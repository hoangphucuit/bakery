...
<div class="inner-header">
	...
	<div class="container">
		<div id="content">
			...
			<form action="{{route('post_dat_hang')}}" method="post" class="beta-form-checkout" >
						...
						<div class="your-order">
							...
							<div class="your-order-body" style="padding: 0px 10px">
								<div class="your-order-item">
									<div>
									<!--  one item	 -->
									@foreach(Session::get('cart')->items as $sp)
										<div class="media">
											<img width="25%" src="{{ url("/") }}/public/source/image/product/{{$sp['item']['image']}}" alt="" class="pull-left">
